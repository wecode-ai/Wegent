...
only substituted boundaries, so production command routing, runtime event
parsing, selection application, callback reconstruction, quoted notifications,
and AI Card projection run together.
"""
