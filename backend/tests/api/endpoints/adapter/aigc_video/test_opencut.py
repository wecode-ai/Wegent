...
from app.api.endpoints.adapter.aigc_video.opencut import (
    _update_timeline,
    build_storycut_bundle,
    storycut_payload_to_tracks,
)
from app.api.endpoints.adapter.aigc_video.opencut_support import (
    build_refined_timeline,
    validate_converted_media_tracks,
)
from app.api.endpoints.adapter.aigc_video.opencut_urls import (
    create_opencut_urls,
...
async def test_opencut_save_uses_lossless_local_timeline_endpoint(
    ...
    monkeypatch.setattr(
        "app.api.endpoints.adapter.aigc_video.opencut.httpx.AsyncClient",
        Client,
    )
    tracks = {
        "video": _timeline()["video_tracks"],
