...
def test_remote_command_policy_separates_read_only_and_mutating_keys():
    ...
    assert CLOUD_ONLY_COMMAND_KEYS == {
        "vnc_clipboard_read",
        "vnc_clipboard_write",
    }
    assert CLOUD_ONLY_COMMAND_KEYS.isdisjoint(REMOTE_DEVICE_COMMAND_KEYS)
    assert CLOUD_DEVICE_COMMAND_KEYS == (
        REMOTE_DEVICE_COMMAND_KEYS | CLOUD_ONLY_COMMAND_KEYS
    )
