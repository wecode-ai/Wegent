...
def test_device_command_selects_commit_identity_by_remote_domain(tmp_path):
    home = tmp_path / "home"
    home.mkdir()
    accounts = [
        {
            "domain": "git.intra.example.com",
            "host": "git.intra.example.com",
            "provider": "gitlab",
            "token": "intra-secret",
        ...
        {
            "domain": "git.external.example.com",
            "host": "git.external.example.com",
            "provider": "gitlab",
            "token": "external-secret",
            "username": "alice-external",
            "identity_name": "alice-external",
            "identity_email": "alice@external.example.com",
        },
    ]

    applied = _run_sync_command(home, accounts)
