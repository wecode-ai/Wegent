...
from wecode.service.video_media_platform import _parse_playback_info, upload_media
...
def test_upload_client_bypasses_environment_proxy(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "wecode.service.video_media_platform.video_media_settings."
    ...
    monkeypatch.setattr("wecode.service.video_media_platform.httpx.Client", FakeClient)
    monkeypatch.setattr(
        "wecode.service.video_media_platform.auth_headers", lambda _uid: {}
    )
