...
from wecode.api.models import router as models_router
...
# models 路由已在模块内声明 prefix="/models"，此处直接挂载，完整路径为 /internal/models
internal_router.include_router(models_router, prefix="/models", tags=["internal"])
