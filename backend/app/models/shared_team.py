...
class SharedTeam(Base):
    ...
    user_id = Column(Integer, nullable=False, index=True)  # User who joined the shared team
    original_user_id = Column(Integer, nullable=False, index=True)  # Original user who created the team
