...
"""Synchronous execution request preparation and model options."""
...
def build_wework_runtime_model_config(
    ...
    *,
    ...
    gateway_config["tool_profile"] = "function"
...
@trace_sync("chat.prepare_execution_request", tracer_name="backend.chat")
def prepare_execution_request(
    ...
    """Resolve models and build the request with a worker-owned session.

    The caller must await completion before reusing the input ORM objects.
    """
