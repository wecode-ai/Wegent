...
from app.services.wiki_repository_access import (
    check_task_user_repo_access,
...
class WikiService:
    ...
    def create_wiki_generation(
        ...
        try:
            ...
            if current_user and obj_in.source_type in ("gitlab", "github"):
                access_result = check_task_user_repo_access(
    ...
    def get_projects(
        ...
        accessible_projects = filter_projects_by_user_access(all_projects, user)
