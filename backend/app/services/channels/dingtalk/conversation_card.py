...
from app.services.channels.dingtalk.card import CheckedDingTalkCardUpdates
...
class DingTalkConversationCardInstance(CheckedDingTalkCardUpdates, AICardReplier):
