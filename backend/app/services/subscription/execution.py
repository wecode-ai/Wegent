    ...
    def cancel_execution(
        ...
        *,
        ...
        if execution.task_id and execution.task_id > 0:
            # This service is called by a synchronous FastAPI route. Keep the
            # important cancellation owned by that bounded route thread instead
            # of detaching work that would outlive its database session.
