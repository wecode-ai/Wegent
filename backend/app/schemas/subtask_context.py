...
class ContextType(str, Enum):
    ...
    ARTIFACT = "artifact"  # Files generated by sandbox (e.g., PPT, DOCX, XLSX)
...
class SubtaskContextBrief(BaseModel):
    ...
    def from_model(cls, context) -> "SubtaskContextBrief":
        ...
        return cls(
            ...
            sandbox_id=type_data.get("sandbox_id"),
        )
...
# ============================================================
# Artifact Schemas (for sandbox-generated files)
# ============================================================


class ArtifactResponse(BaseModel):
    """Artifact response for sandbox-generated files."""
    ...
    status: str
    file_extension: str = ""
    file_path: Optional[str] = None  # Original path in sandbox
    sandbox_id: Optional[str] = None
    created_at: Optional[datetime] = None
    ...
    @classmethod
    def from_context(cls, context) -> "ArtifactResponse":
        """Create from SubtaskContext model."""
        type_data = context.type_data or {}
        return cls(
            id=context.id,
