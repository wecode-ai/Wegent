...
# ==================== Public Ghost Management Endpoints ====================
...
async def create_public_ghost(
    ...
    return PublicGhostResponse(
        id=new_ghost.id,
        name=new_ghost.name,
        namespace=new_ghost.namespace,
        display_name=_get_ghost_display_name(new_ghost),
        description=_get_ghost_description(new_ghost),
        ghost_json=new_ghost.json,
        is_active=new_ghost.is_active,
        created_at=new_ghost.created_at,
        updated_at=new_ghost.updated_at,
    )
...
async def delete_public_ghost(
    ...
    for bot in bots_using_ghost:
        spec = bot.json.get("spec", {}) if bot.json else {}
        ghost_ref = spec.get("ghostRef", {})
        if (
...
# ==================== Public Shell Management Endpoints ====================
...
async def create_public_shell(
    ...
    return PublicShellResponse(
        id=new_shell.id,
        name=new_shell.name,
        namespace=new_shell.namespace,
        display_name=_get_shell_display_name(new_shell),
        shell_type=_get_shell_type(new_shell),
        shell_json=new_shell.json,
        is_active=new_shell.is_active,
        created_at=new_shell.created_at,
        updated_at=new_shell.updated_at,
    )
