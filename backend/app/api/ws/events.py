...
class ChatSendPayload(BaseModel):
    ...
    attachment_id: Optional[int] = Field(None, description="Optional attachment ID (deprecated, use attachment_ids)")
    attachment_ids: Optional[List[int]] = Field(None, description="Optional list of attachment IDs")
