...
INSERT INTO `teams` (`id`, `user_id`, `k_id`, `name`, `bots`, `workflow`, `is_active`, `created_at`, `updated_at`) VALUES	('1', '1', '5', 'dev-team', '[{\"bot_id\": 1, \"bot_prompt\": \"\"}]', '{\"mode\": \"pipeline\", \"system_prompt\": \"You are a collaborative AI team that works together to solve complex programming tasks. Each member contributes their expertise to achieve the best possible results.\"}', '1', '2025-09-04 12:58:21', '2025-09-04 12:58:21');