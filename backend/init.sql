...
VALUES
	...
	('5', '1', 'Team', 'dev-team', 'default', '{\"kind\": \"Team\", \"spec\": {\"members\": [{\"name\": \"developer\", \"botRef\": {\"name\": \"developer-bot\", \"namespace\": \"default\"}, \"prompt\": \"\"}], \"collaborationModel\": \"pipeline\"}, \"status\": {\"state\": \"Available\"}, \"metadata\": {\"name\": \"dev-team\", \"namespace\": \"default\"}, \"apiVersion\": \"agent.wecode.io/v1\"}', '1', '2025-09-04 04:58:22', '2025-09-04 04:58:22');
...
INSERT INTO `teams` (`id`, `user_id`, `k_id`, `name`, `bots`, `workflow`, `is_active`, `created_at`, `updated_at`) VALUES	('1', '1', '5', 'dev-team', '[{\"bot_id\": 1, \"bot_prompt\": \"\"}]', '{\"mode\": \"pipeline\"}', '1', '2025-09-04 12:58:21', '2025-09-04 12:58:21');