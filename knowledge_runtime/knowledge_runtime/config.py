...
class Settings(BaseSettings):
    ...
    log_file_enabled: bool = Field(
        default=True,
        validation_alias=AliasChoices(
            "KNOWLEDGE_RUNTIME_LOG_FILE_ENABLED", "LOG_FILE_ENABLED"
        ),
    )
    log_dir: str = Field(
        default="./logs",
    ...
    # Database configuration for reference mode
    # Required when using reference mode to resolve CRD configs from database
