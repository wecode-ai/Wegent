...
from shared.telemetry import get_meter, is_telemetry_enabled
...
def _record_metric_from_call(
    ...
    try:
        ...
        counter = meter.create_counter(name=metric_name, description=f"Auto-tracked: {metric_name}")
...
def _record_duration_from_call(
    ...
    try:
        ...
        histogram = meter.create_histogram(
            name=metric_name, description=f"Auto-tracked duration: {metric_name}", unit="ms"
        )
