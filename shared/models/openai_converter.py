...
class OpenAIRequestConverter:
    ...
    def from_execution_request(request: ExecutionRequest) -> dict[str, Any]:
        ...
        metadata = {
            ...
            "standalone_chat_workspace": request.standalone_chat_workspace,
            "workspace_source": request.workspace_source,
            "project_workspace_path": request.project_workspace_path,
            "execution_target_type": request.execution_target_type,
    ...
    def to_execution_request(openai_request: dict[str, Any]) -> ExecutionRequest:
        ...
        return ExecutionRequest(
            ...
            standalone_chat_workspace=metadata.get("standalone_chat_workspace", False),
            workspace_source=metadata.get("workspace_source"),
            project_workspace_path=metadata.get("project_workspace_path"),
            execution_target_type=metadata.get("execution_target_type"),
