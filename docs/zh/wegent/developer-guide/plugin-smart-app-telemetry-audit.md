...
事件以 `wework/src/telemetry/registry/` 为唯一来源，生成 TypeScript 白名单、公开 JSON 和 Markdown 目录。当前插件 36 个、智能应用 35 个，共 71 个事件。完整名称和失败阶段见 `wework/telemetry/catalog/public-events.md`。
