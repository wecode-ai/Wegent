...
- CPU, memory, and disk usage for cloud devices, plus connection details, upgrade, restart, and delete actions. During an upgrade or restart, the device briefly goes offline and the page reports progress until it reconnects.
