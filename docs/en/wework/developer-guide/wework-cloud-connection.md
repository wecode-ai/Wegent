...
Local model configs are stored in local browser storage. They are not written to Backend as Model CRDs and do not become account-level persistent configuration. Each config includes:
