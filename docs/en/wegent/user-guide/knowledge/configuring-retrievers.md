...
is widened internally to `top_k * 4` (floor 50, ceiling 1000), because a chunk
recalled by only one branch scores 0 in the other one and a pool that is too
narrow drops the right chunk before fusion.
