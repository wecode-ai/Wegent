...
| **Desktop**  | `GET /api/cloud-devices/{device_id}/vnc-config` | Opens the cloud-device VNC desktop in the system default browser through Wework's loopback session bridge                                                                                             |
