...
| `spec.allowedUsersEnabled` | boolean | No | Explicit switch for whitelist-only mode; when `true`, access is governed strictly by `allowedUsers`, and an empty list denies everyone. |
