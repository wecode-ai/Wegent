...
| External OAuth identity tokens                     | [external-oauth-provider.md](external-oauth-provider.md)                             | Client registration, authorization code, PKCE, refresh rotation, userinfo, Wegent API auth isolation           |
