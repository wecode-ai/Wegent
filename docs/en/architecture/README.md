...
| Shared capability reference resolution             | [capability-reference-resolution.md](capability-reference-resolution.md)     | Visible references, source Kinds, sharing grants, Backend and Runtime consistency                               |
