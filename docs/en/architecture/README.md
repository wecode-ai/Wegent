...
| Runtime conversation queue settlement              | [runtime-conversation-queue.md](runtime-conversation-queue.md)               | Turn terminal state, Executor idle confirmation, serial delivery, turn ownership                             |
