...
| Board first-screen read snapshot                    | [board-read-snapshot.md](board-read-snapshot.md)                             | Issues, task bindings, members, agents, single-request loading, and live invalidation                          |
...
| Board Issue unread projection                      | [board-item-unread-projection.md](board-item-unread-projection.md)             | Content revisions, per-user read cursors, dynamic updates, live invalidation, board unread indicators           |
