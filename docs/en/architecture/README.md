...
| DeepSeek Harness capability apps                   | [deepseek-harness-apps.md](deepseek-harness-apps.md)                         | Package validation, version binding, model proxying, isolated instances, tabs, and process cleanup            |
