...
| Shared RAG Model reference resolution              | [capability-reference-resolution.md](capability-reference-resolution.md)     | Model references, source Kinds, sharing grants, Backend RAG and Knowledge Runtime consistency                 |
| Embedding dimension contract                       | [embedding-dimension-contract.md](embedding-dimension-contract.md)           | Model config, provider requests and responses, Runtime errors, Backend indexing-failure projection            |
