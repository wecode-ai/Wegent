export const DESKTOP_CHAT_CONTENT_BASE_CLASS =
  'mx-auto min-w-0 px-0 transition-[width,max-width] [transition-duration:300ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none'
