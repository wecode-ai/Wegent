...
describe("IssueAutomationExecutionSummary", () => {
  ...
  it("counts only executor work and omits manager planning and review stages", () => {
    render([
      {
        ...nodes[0],
        id: "manager",
    ...
    expect(container.textContent).not.toContain("负责人规划");
    expect(container.textContent).not.toContain("负责人验收");
    expect(container.textContent).toContain("Claude 实现");
  });
