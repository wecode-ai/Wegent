        ...
        createPortal(
          <div
            ...
            className={[
              ...
              'fixed z-system-popover w-[22rem] max-w-[calc(100vw-2rem)] overflow-y-auto rounded-xl border border-border bg-background p-1.5 shadow-[0_12px_32px_rgba(0,0,0,0.12)]',
            ].join(' ')}
          >
            <button
              type="button"
