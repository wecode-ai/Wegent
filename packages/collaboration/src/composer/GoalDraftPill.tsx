...
export interface ComposerModePillProps {
...
export interface GoalDraftPillProps {
  translate: CollaborationTranslate
  onCancel?: () => void
  className?: string
}

export function GoalDraftPill({ translate: t, onCancel, className = '' }: GoalDraftPillProps) {
  return (
    <ComposerModePill
      translate={t}
