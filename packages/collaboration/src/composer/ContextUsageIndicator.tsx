...
import { runtimeContextUsageMetrics } from '@wegent/chat-core/runtime-context-usage'
import { activityClassNames as cn } from '../issue-detail/activityClassNames'
import type { RuntimeContextUsage } from '@wegent/chat-core/runtime'
...
export function ContextUsageIndicator({
  usage,
  translate: t,
  compactionThreshold = DEFAULT_CONTEXT_COMPACTION_THRESHOLD,
  disabled = false,
  onCompactContext,
  ...
  return (
    <div
      ref={containerRef}
      className="group relative flex h-4 w-4 shrink-0 translate-y-[1px] items-center justify-center max-md:h-11 max-md:w-11"
      data-testid="context-usage-indicator"
      aria-label={t('workbench.context_usage_aria', undefined, {
    ...
    >
      <button
        ...
        className={cn(
          'context-usage-compact-trigger flex h-4 w-4 items-center justify-center rounded-full disabled:cursor-default max-md:h-11 max-md:w-11',
      ...
      {!confirmOpen && (
        <>
          <div className="pointer-events-auto absolute bottom-full left-1/2 z-system-popover hidden h-3 w-24 -translate-x-1/2 cursor-default group-hover:block group-focus-within:block" />
          <div className="pointer-events-auto absolute bottom-[calc(100%+0.75rem)] left-1/2 z-system-popover hidden w-max -translate-x-1/2 cursor-default rounded-2xl border border-border/70 bg-background px-4 py-3 text-center text-sm leading-5 text-text-primary shadow-[0_14px_42px_rgba(15,23,42,0.16)] group-hover:block group-focus-within:block">
            ...
            <div className="whitespace-nowrap font-light">
              {t('workbench.context_usage_percent', undefined, {
                usedPercent: metrics.usedPercent,
                remainingPercent: metrics.remainingPercent,
              })}
            </div>
            <div className="whitespace-nowrap font-light">
              {t('workbench.context_usage_tokens', undefined, {
            ...
            {overThreshold && !disabled && onCompactContext && (
              <button
                ...
                className="mt-1.5 flex items-center justify-center gap-1 whitespace-nowrap font-light text-red-500 hover:underline max-md:min-h-11 max-md:min-w-11"
              >
        ...
        createPortal(
          <div
            ...
            className={cn(
              ...
              'pointer-events-auto fixed z-system-popover w-[13.5rem] cursor-default rounded-xl border border-border/80 bg-background p-3 text-left text-sm leading-5 text-text-primary shadow-[0_14px_42px_rgba(15,23,42,0.14)]'
            )}
          >
            <div className="mb-3 pr-7 max-md:pr-11">
            ...
            <button
              ...
              className="absolute right-2 top-2 flex h-6 w-6 items-center justify-center rounded-full text-text-secondary hover:bg-muted hover:text-text-primary max-md:h-11 max-md:w-11"
            ...
            <div className="flex items-center justify-end gap-1.5">
              <button
                ...
                className="inline-flex h-7 items-center rounded-full px-2.5 text-xs font-medium text-text-secondary hover:bg-muted hover:text-text-primary max-md:min-h-11 max-md:min-w-11"
              >
              ...
              <button
                ...
                className="inline-flex h-7 items-center gap-1.5 rounded-full bg-text-primary px-2.5 text-xs font-medium text-background hover:bg-text-primary/90 max-md:min-h-11 max-md:min-w-11"
              >
                <FileArchive className="h-3.5 w-3.5" />
