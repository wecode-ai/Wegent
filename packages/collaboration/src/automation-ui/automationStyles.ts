...
const FLOATING_SURFACE =
  "rounded-xl border border-border/80 bg-background/95 shadow-md";
...
const recipes: Record<string, string> = {
  ...
  "project-content":
    "h-full min-h-0 w-full overflow-y-auto bg-background px-6 pb-10 pt-5 xl:px-8",
  "project-page-title":
  ...
  "automation-grid":
    "grid grid-cols-[repeat(auto-fill,minmax(320px,1fr))] items-stretch gap-4",
  "create-card":
  ...
  "card-footer":
    "-mx-5 mt-4 flex min-h-16 items-center gap-3 border-t border-border/60 px-5 py-3",
  "card-last-run":
  ...
  "template-store-mark":
    "grid size-10 place-items-center rounded-xl bg-[#f4eadc] text-[#8a5b20]",
  "template-search":
  ...
  "template-card-main":
    "grid grid-cols-[40px_minmax(0,1fr)] items-start gap-3 p-4 text-left",
  "template-icon":
  ...
  "template-preview-empty":
    "grid h-full place-items-center text-center text-sm text-text-muted",
  "editor-shell":
  ...
  "automation-node-handle":
    "!h-4 !w-2 !rounded-sm !border-2 !border-background !bg-focus",
  "workflow-node-shell":
  ...
  "subgraph-count":
    "whitespace-nowrap rounded-md bg-muted px-2 py-1 text-xs text-text-secondary",
  ...
  "react-flow-branch-empty":
    "grid h-[30px] place-items-center text-xs text-text-muted",
  ...
  "event-source-settings":
    "grid gap-4 rounded-xl border border-border/70 bg-muted/20 p-4",
