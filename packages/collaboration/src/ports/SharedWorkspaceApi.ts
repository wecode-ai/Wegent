...
export interface SharedWorkspaceProjectsApi {
  ...
  listMyWork(): Promise<WorkspaceMyWorkItem[]>
  importMessages(
    projectId: string,
...
export interface SharedWorkspaceTaskBindingsApi {
  list(issueId: string): Promise<WorkspaceTaskBinding[]>
}
...
export interface SharedWorkspaceDeliveriesApi {
  ...
  create(
    issueId: string,
    input: { markdown: string; chat?: Record<string, unknown> }
...
export interface SharedWorkspaceRuntimeProfilesApi {
  ...
  getProjectDefault(
    projectId: string
  ): Promise<{ projectId: string; userId: number; runtimeProfileId: string | null }>
  setProjectDefault(
    projectId: string,
...
export interface WeworkWorkspaceRuntimePort {
  ...
  reportExecutionLifecycle(
    ...
    executionId: number,
    event:
      | { type: 'heartbeat'; runtimeDeviceId: string | null; runtimeTaskId: string | null }
      | { type: 'start_requested'; runtimeDeviceId: string; runtimeTaskId: string }
      | { type: 'dispatch_unknown'; runtimeDeviceId: string; runtimeTaskId: string; error: string }
      | {
          type: 'runtime_start'
