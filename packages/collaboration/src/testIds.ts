...
export const collaborationTestIds = {
  ...
  issueDeleteDialog: "collaboration-issue-delete-dialog",
  issueDeleteCancel: "collaboration-issue-delete-cancel",
  issueDeleteConfirm: "collaboration-issue-delete-confirm",
  issueDeleteError: "collaboration-issue-delete-error",
