...
import kimi from '../../../shared/assets/codex-models/kimi.json'
import deepseek from '../../../shared/assets/codex-models/deepseek.json'
import openai from '../../../shared/assets/codex-models/openai.json'

const BUILTIN_CATALOG_MODELS: CatalogModel[] = [kimi, deepseek, openai].flatMap(
  resource => (resource as CatalogResource).models ?? []
)
