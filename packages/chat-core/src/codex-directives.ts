...
function parseInlineVisualization(
  line: string,
): CodexInlineVisualizationPart | null {
  ...
  if (legacyMatch) {
    ...
    return isSafeLegacyVisualizationFile(file)
      ? { kind: "visualization", file }
      : null;
  }
