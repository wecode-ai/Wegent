...
wework_desktop_cloud_e2e_matrix={"include":[{"id":"cloud-1","name":"Cloud / shard 1","segments":"rendering-extensions,cloud-worktree-queued-cancel,embedded-browser,cloud-worktree-capability,priority-filter,telemetry-consent"},{"id":"cloud-2","name":"Cloud / shard 2","segments":"cloud-worktree-create,core-task-flow,workspace-tabs,supervisor-lifecycle"},{"id":"cloud-3","name":"Cloud / shard 3","segments":"cloud-worktree-archive-restore,resilience,cloud-worktree-tools,workspace-attachments,automation-lifecycle"},{"id":"cloud-4","name":"Cloud / shard 4","segments":"conversation-state,window-lifecycle,project-automation,plugin-auto-update"},{"id":"cloud-5","name":"Cloud / shard 5","segments":"goal-lifecycle,model-routing,cloud-worktree-device-restart,browser-multi-tabs"}]}
