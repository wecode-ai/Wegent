...
full_desktop_expected="${full_desktop_expected/\"segments\":\"project-automation\"/\"segments\":\"project-automation,local-project-automation-chain,collaboration-agent-automation-chain\"}"
