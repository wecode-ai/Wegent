...
assert_desktop_case "temporary chat files select temporary chat coverage" \
  'wework_desktop_e2e=true
wework_desktop_core_e2e=true
wework_desktop_core_e2e_matrix={"include":[{"id":"core-temporary-chat","name":"Core / temporary-chat","command":"e2e:desktop","segment":"temporary-chat"}]}
wework_desktop_other_e2e=false
wework_desktop_other_e2e_matrix={"include":[]}' \
...
assert_desktop_case "local harness files select local harness coverage" \
  'wework_desktop_e2e=true
wework_desktop_core_e2e=true
wework_desktop_core_e2e_matrix={"include":[{"id":"core-claude-runtime","name":"Core / claude-runtime","command":"e2e:desktop","segment":"claude-runtime"},{"id":"core-local-harness","name":"Core / local-harness","command":"e2e:desktop","segment":"local-harness"}]}
wework_desktop_other_e2e=false
wework_desktop_other_e2e_matrix={"include":[]}' \
...
assert_desktop_case "Claude runtime messaging selects task and Claude coverage" \
  'wework_desktop_e2e=true
wework_desktop_core_e2e=true
wework_desktop_core_e2e_matrix={"include":[{"id":"core-core-task-flow","name":"Core / core-task-flow","command":"e2e:desktop","segment":"core-task-flow"},{"id":"core-claude-runtime","name":"Core / claude-runtime","command":"e2e:desktop","segment":"claude-runtime"}]}
wework_desktop_other_e2e=false
wework_desktop_other_e2e_matrix={"include":[]}' \
