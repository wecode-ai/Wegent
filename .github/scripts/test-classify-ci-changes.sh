...
wework_desktop_core_e2e_matrix={"include":[{"id":"core-1","name":"Core / shard 1","segments":"issue-dispatch-unified-board"},{"id":"core-9","name":"Core / shard 9","segments":"collaboration-first-use,collaboration-group-onboarding,collaboration-local-executor-issue-tools,issue-dispatch-agent,issue-dispatch-group-round"},{"id":"core-10","name":"Core / shard 10","segments":"collaboration-shared-core,issue-dispatch-cancellation"},{"id":"core-11","name":"Core / shard 11","segments":"collaboration-settings-matrix"},{"id":"core-12","name":"Core / shard 12","segments":"collaboration-issue-comment-mention,issue-dispatch-human"},{"id":"core-15","name":"Core / shard 15","segments":"collaboration-issue-comment-notification"}]}
wework_desktop_other_e2e=false
wework_desktop_other_e2e_matrix={"include":[]}' \
  "packages/collaboration/src/CollaborationApp.tsx"
...
assert_desktop_case "collaboration execution environment changes select onboarding and lifecycle coverage" \
  'wework_desktop_e2e=true
wework_desktop_core_e2e=true
wework_desktop_core_e2e_matrix={"include":[{"id":"core-1","name":"Core / shard 1","segments":"issue-dispatch-unified-board"},{"id":"core-2","name":"Core / shard 2","segments":"remote-device-onboarding"},{"id":"core-9","name":"Core / shard 9","segments":"collaboration-first-use,collaboration-group-onboarding,collaboration-local-executor-issue-tools,issue-dispatch-agent,issue-dispatch-group-round"},{"id":"core-10","name":"Core / shard 10","segments":"collaboration-shared-core,issue-dispatch-cancellation"},{"id":"core-11","name":"Core / shard 11","segments":"collaboration-settings-matrix"},{"id":"core-12","name":"Core / shard 12","segments":"issue-dispatch-human"}]}
wework_desktop_cloud_e2e=true
...
full_desktop_expected="${full_desktop_expected/\"segments\":\"resilience\"/\"segments\":\"resilience,environment-panel-scroll,collaboration-shared-core,issue-dispatch-cancellation\"}"
...
assert_desktop_case "Issue Dispatch scenario selects every dispatch checkpoint" \
  'wework_desktop_e2e=true
wework_desktop_core_e2e=true
wework_desktop_core_e2e_matrix={"include":[{"id":"core-1","name":"Core / shard 1","segments":"issue-dispatch-unified-board"},{"id":"core-9","name":"Core / shard 9","segments":"issue-dispatch-agent,issue-dispatch-group-round"},{"id":"core-10","name":"Core / shard 10","segments":"issue-dispatch-cancellation"},{"id":"core-12","name":"Core / shard 12","segments":"issue-dispatch-human"}]}
wework_desktop_other_e2e=false
wework_desktop_other_e2e_matrix={"include":[]}' \
...
assert_desktop_case "backend Issue Dispatch changes select every dispatch checkpoint" \
  'wework_desktop_e2e=true
wework_desktop_core_e2e=true
wework_desktop_core_e2e_matrix={"include":[{"id":"core-1","name":"Core / shard 1","segments":"issue-dispatch-unified-board"},{"id":"core-9","name":"Core / shard 9","segments":"issue-dispatch-agent,issue-dispatch-group-round"},{"id":"core-10","name":"Core / shard 10","segments":"issue-dispatch-cancellation"},{"id":"core-12","name":"Core / shard 12","segments":"issue-dispatch-human"}]}
wework_desktop_other_e2e=false
