...
import { deviceDesktopRoute } from '@wecode/features/vnc/deviceDesktopRoute'
import type {
  DeviceSurfaceActionProps,
  DeviceSurfaceLaunchOptions,
  DeviceSurfaceWorkspaceActionProps,
} from '@/extensions/device-surface-contract'
