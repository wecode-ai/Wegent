  ...
  factory: () => ({
    ...
    apply(ctx) {
      ctx.slots.inject('wework.workspace.menu.section', () =>
        ctx.wework.contributions.register(ctx, 'wework.workspace.menu.section', {
      ...
      ctx.slots.inject('wework.project.create.section', () =>
        ctx.wework.contributions.register(ctx, 'wework.project.create.section', {
      ...
      ctx.slots.inject('wework.project.work.section', () =>
        ctx.wework.contributions.register(ctx, 'wework.project.work.section', {
          id: 'git-project-work',
      ...
      ctx.slots.inject('wework.runtime-profile.workspace-policy', () =>
        ctx.wework.contributions.register(ctx, 'wework.runtime-profile.workspace-policy', {
          id: 'git_worktree',
          label: '新工作树',
      ...
      for (const contribution of [
        ...
        ctx.slots.inject(contribution.slot, () =>
          ctx.wework.contributions.register(ctx, contribution.slot, contribution.descriptor)
        )
      }
