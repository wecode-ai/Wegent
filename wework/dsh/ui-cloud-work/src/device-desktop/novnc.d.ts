declare module '@novnc/novnc' {
  ...
  interface RfbEventMap {
    ...
    clipboardpastecomplete: CustomEvent<Record<string, never>>
    connect: Event
    disconnect: CustomEvent<{ clean?: boolean }>
    encodingchange: CustomEvent<{ encoding: number; name: string }>
    framebufferupdate: CustomEvent<Record<string, never>>
