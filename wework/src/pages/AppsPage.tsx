  ...
  return (
    <article className="rounded-3xl border border-border bg-background p-5">
      ...
      <div className="mt-5 space-y-3">
        ...
        />
        <MetricRow label="在线设备" value={onlineCount} max={Math.max(devices.length, 1)} display={`${onlineCount}`} />
            ...
            <>
              ...
              <section className="mt-6">
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                  ...
                  <QuickAction icon={Grid3X3} title="内置应用" detail="打开 Wegent、Codex 等工作入口" />
                  <QuickAction icon={ShieldCheck} title="权限与认证" detail="管理 Codex 与应用授权" />
                </div>
              </section>
