  ...
  return (
    <span className="group relative inline-flex shrink-0">
      ...
      <span
        ...
        data-testid={testId}
        className={cn(
          'pointer-events-none absolute top-[calc(100%+6px)] z-system-popover inline-flex h-9 items-center gap-1.5 whitespace-nowrap rounded-xl border border-white/10 bg-[#2b2c2f]/95 px-3 text-[13px] font-medium leading-[18px] text-white opacity-0 shadow-[0_10px_28px_rgba(0,0,0,0.32)] ring-1 ring-black/10 backdrop-blur-md transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100',
      ...
      >
        ...
        {shortcut ? (
          <KeyboardShortcut
            value={shortcut}
            className="h-6 bg-white/10 px-2 text-[13px] text-white/95"
          />
        ) : null}
      </span>
    </span>
