      ...
      <div className="flex items-center justify-between gap-6">
        ...
        <div ref={menuRef} className="relative shrink-0">
          <button
            ...
            className="inline-flex h-8 min-w-[104px] items-center justify-between gap-2 rounded-lg border border-border bg-surface px-3 text-[13px] font-medium text-text-primary transition-colors hover:bg-muted"
          >
