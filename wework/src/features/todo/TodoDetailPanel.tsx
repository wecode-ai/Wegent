          ...
          <section className="mt-[18px] grid gap-2 sm:grid-cols-2">
            {item.blocker && (
              <div className="rounded-lg border border-destructive/20 bg-destructive/5 p-3">
                ...
                <p className="mt-1 text-[11px] text-text-secondary">{item.blocker}</p>
              </div>
            )}
            {item.nextAction && (
              <div className="rounded-lg border border-border bg-muted/40 p-3">
                ...
                <p className="mt-1 text-[11px] text-text-secondary">{item.nextAction}</p>
              </div>
            )}
          </section>
        )}
                ...
                <div className="flex items-center gap-1">
                  {workTypes.map(({ key, name }) => (
                    <button
                      ...
                      className="flex h-7 items-center gap-1 rounded-md px-2 text-[10px] text-text-secondary hover:bg-muted hover:text-text-primary"
                    >
            ...
            {item.children && item.children.length > 0 ? (
              <div className="mt-2 divide-y divide-border overflow-hidden rounded-lg border border-border">
                {item.children.map(child => (
                  ...
                  >
                    <span className="min-w-12 rounded bg-primary/10 px-1.5 py-1 text-center text-[10px] font-medium text-primary">
                    ...
                    {child.blocker ? (
                      ...
                      <span className="max-w-40 truncate text-[9px] text-amber-600">
              ...
              <div className="mt-2 rounded-lg border border-dashed border-border px-4 py-4">
                ...
                <button
                  ...
                  className="mt-3 h-8 rounded-md bg-primary px-3 text-[11px] font-medium text-primary-contrast hover:bg-primary/90"
                >
              ...
              <div className="mt-2 rounded-lg border border-dashed border-border px-4 py-4">
                ...
                <button
                  ...
                  className="mt-3 h-8 rounded-md border border-border bg-surface px-3 text-[11px] font-medium text-text-primary hover:bg-muted"
                >
          ...
          <section className="mt-[18px]" data-testid="todo-detail-shared-workspace">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="flex h-7 items-center gap-1 rounded-md px-2 text-[10px] text-text-secondary hover:bg-muted"
                >
                  <Plus className="h-3 w-3" />
            ...
            <div className="mt-2 divide-y divide-border overflow-hidden rounded-lg border border-border">
              {workspaceEntries.map(entry => (
                <div key={entry.path} className="flex h-9 items-center gap-2 px-3 text-[10px]">
            ...
            {workspaceError && (
              <p data-testid="todo-workspace-error" className="mt-2 text-[10px] text-destructive">
                {workspaceError}
              </p>
            )}
          </section>
              ...
              {onUpdateItem ? (
                <EditableProperty icon={CircleDot} label={t('todo.status', '状态')}>
                  <select
                    ...
                    className="h-7 w-full bg-transparent text-[10px] text-text-primary outline-none"
                  >
                  ...
                  {item.waitingFor && item.waitingFor.length > 0 && (
                    <span
                      ...
                      className="block truncate text-[8px] text-amber-600"
                    >
            ...
            {(item.events?.length
              ...
              <div key={event.id} className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[9px] text-[#929AA1]">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          {onConfirm && item.state === 'review' && (
            <button
              ...
              onClick={onConfirm}
              className="flex h-[34px] items-center gap-1.5 rounded-md bg-primary px-3.5 text-[11px] font-semibold text-primary-contrast hover:bg-primary/90"
            >
...
function EditableProperty({
  ...
  return (
    <label className="flex min-w-0 items-center gap-2 rounded-md bg-[#F7F8F9] px-2.5 dark:bg-muted">
      <span className="flex shrink-0 items-center gap-1.5 text-[10px] text-[#7A838B]">
        <Icon className="h-3.5 w-3.5" />
        {label}
      </span>
