...
describe('createAppUpdateError', () => {
  ...
  test('recognizes an update source that lacks the selected Beta platform', () => {
    const error = createAppUpdateError(
      new Error("the platform 'beta-darwin' was not found in the response `platforms` object"),
      'check',
      1
    )
