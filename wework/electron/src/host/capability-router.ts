...
export const HOST_CAPABILITIES = [
  ...
  'systemRecordReplay.cancel',
  'systemRecordReplay.delete',
  'systemRecordReplay.list',
  'systemRecordReplay.openPermissionSettings',
  'systemRecordReplay.replay',
  'systemRecordReplay.requestPermissions',
  'systemRecordReplay.start',
  'systemRecordReplay.status',
  'systemRecordReplay.stop',
  'tray.setState',
