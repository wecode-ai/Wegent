...
function feedbackSubmitRequestParam(params: Record<string, unknown>): FeedbackSubmitRequest {
  const request = recordParam(params, 'request')
  return {
    apiUrl: requiredStringValue(request.apiUrl, 'request.apiUrl'),
    accessToken: requiredStringValue(request.accessToken, 'request.accessToken'),
    stagingId: requiredStringValue(request.stagingId, 'request.stagingId'),
    title: requiredStringValue(request.title, 'request.title'),
    description:
      typeof request.description === 'string'
        ? request.description
        : invalidParam('request.description'),
