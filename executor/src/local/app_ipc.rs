...
const GIT_GENERATE_COMMIT_MESSAGE_SCRIPT: &str = r#"
import json
import os
import shutil
import subprocess
...
fn local_app_command(command_key: &str) -> Option<LocalAppCommandDefinition> {
    match command_key {
        ...
        "git_generate_commit_message" => Some(command_definition(
            "python3 -c <generate git commit message>",
            &["python3", "-c", GIT_GENERATE_COMMIT_MESSAGE_SCRIPT],
            Some(PostProcessor::Json),
        )),
