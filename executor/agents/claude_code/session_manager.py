...
class SessionManager:
    ...
    async def close_client(cls, session_id: str) -> bool:
        ...
        Implements multi-level shutdown:
        1. Try graceful disconnect with timeout
        2. Force terminate process if disconnect fails or times out
        3. Handle cancel-scope mismatch errors
    ...
    async def close_all_clients(cls) -> None:
        ...
        Uses close_client for each client to ensure proper cleanup with
        timeout protection and force termination if needed.
        """
