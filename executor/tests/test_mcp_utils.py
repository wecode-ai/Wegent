...
class TestGetNestedValue:
    ...
    def test_simple_attribute(self):
        """Test getting a simple top-level attribute"""
        data = ExecutionRequest(git_repo="owner/repo", branch_name="main")
    ...
    def test_nested_dict_key(self):
        """Test getting nested keys from dict attributes"""
        data = ExecutionRequest(user={"name": "John", "id": 123})
    ...
    def test_nonexistent_key(self):
        ...
        data = ExecutionRequest(user={"name": "John"})
    ...
    def test_empty_path(self):
        ...
        data = ExecutionRequest(git_repo="owner/repo")
    ...
    def test_list_index_out_of_range(self):
        ...
        data = ExecutionRequest(bot=[{"name": "bot1"}])
...
class TestReplacePlaceholdersInString:
    ...
    def test_single_placeholder(self):
        ...
        task_data = ExecutionRequest(user={"name": "John"})
    ...
    def test_numeric_value(self):
        ...
        task_data = ExecutionRequest(user={"id": 12345})
...
class TestReplaceMcpServerVariables:
    ...
    def test_top_level_placeholders(self):
        """Test with top-level task_data attributes"""
        mcp_servers = {
            "repo": "${{git_repo}}",
            "branch": "${{branch_name}}",
            "url": "${{git_url}}",
