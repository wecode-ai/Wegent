...
def register_envd_routes(app: FastAPI):
    ...
    async def process_list(request: Request):
        ...
        return await _handle_unary(
            request, _process_handler.List,
            process_pb2.ListRequest, process_pb2.ListResponse
        )
    ...
    async def process_start(request: Request):
        ...
        return await _handle_server_stream(
            request, _process_handler.Start,
            process_pb2.StartRequest, process_pb2.StartResponse
        )
    ...
    async def process_connect(request: Request):
        ...
        from .gen.process.process import process_pb2
        return await _handle_server_stream(
            request, _process_handler.Connect,
            process_pb2.ConnectRequest, process_pb2.ConnectResponse
        )
    ...
    async def process_update(request: Request):
        ...
        from .gen.process.process import process_pb2
        return await _handle_unary(
            request, _process_handler.Update,
            process_pb2.UpdateRequest, process_pb2.UpdateResponse
        )
    ...
    async def process_send_input(request: Request):
        ...
        from .gen.process.process import process_pb2
        return await _handle_unary(
            request, _process_handler.SendInput,
            process_pb2.SendInputRequest, process_pb2.SendInputResponse
        )
    ...
    async def process_stream_input(request: Request):
        ...
        return await _handle_client_stream(
            request, _process_handler.StreamInput,
            process_pb2.StreamInputRequest, process_pb2.StreamInputResponse
        )
    ...
    async def process_send_signal(request: Request):
        ...
        from .gen.process.process import process_pb2
        return await _handle_unary(
            request, _process_handler.SendSignal,
            process_pb2.SendSignalRequest, process_pb2.SendSignalResponse
        )
    ...
    async def filesystem_stat(request: Request):
        ...
        return await _handle_unary(
            request, _filesystem_handler.Stat,
            filesystem_pb2.StatRequest, filesystem_pb2.StatResponse
        )
    ...
    async def filesystem_mkdir(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.MakeDir,
            filesystem_pb2.MakeDirRequest, filesystem_pb2.MakeDirResponse
        )
    ...
    async def filesystem_move(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.Move,
            filesystem_pb2.MoveRequest, filesystem_pb2.MoveResponse
        )
    ...
    async def filesystem_listdir(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.ListDir,
            filesystem_pb2.ListDirRequest, filesystem_pb2.ListDirResponse
        )
    ...
    async def filesystem_remove(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.Remove,
            filesystem_pb2.RemoveRequest, filesystem_pb2.RemoveResponse
        )
    ...
    async def filesystem_watchdir(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_server_stream(
            request, _filesystem_handler.WatchDir,
            filesystem_pb2.WatchDirRequest, filesystem_pb2.WatchDirResponse
        )
    ...
    async def filesystem_create_watcher(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.CreateWatcher,
            filesystem_pb2.CreateWatcherRequest, filesystem_pb2.CreateWatcherResponse
        )
    ...
    async def filesystem_get_watcher_events(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.GetWatcherEvents,
            filesystem_pb2.GetWatcherEventsRequest, filesystem_pb2.GetWatcherEventsResponse
        )
    ...
    async def filesystem_remove_watcher(request: Request):
        ...
        from .gen.filesystem.filesystem import filesystem_pb2
        return await _handle_unary(
            request, _filesystem_handler.RemoveWatcher,
            filesystem_pb2.RemoveWatcherRequest, filesystem_pb2.RemoveWatcherResponse
        )
...
async def _handle_unary(request: Request, handler, req_class, resp_class):
    ...
    try:
        ...
        return Response(
            content=json.dumps({"code": "invalid_argument", "message": f"Invalid request: {str(e)}"}),
            status_code=400,
            media_type="application/json",
            headers={"Connect-Protocol-Version": "1"}
        )
