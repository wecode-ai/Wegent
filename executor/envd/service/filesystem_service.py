...
- Unix: Uses pwd and grp for user/group info
- Windows: Uses win32security via platform abstraction layer
"""
...
# Platform abstraction for cross-platform user/group info
from executor.platform_compat import get_user_info_provider
...
class FilesystemServiceHandler:
    ...
    def _get_entry_info(self, path: str) -> filesystem_pb2.EntryInfo:
        ...
        try:
            ...
            # Get owner and group using platform abstraction
            user_info = get_user_info_provider()
