...
**Recent design docs:**
- Task UID hash sharding and centralized ID allocation: [`docs/zh/developer-guide/task-uid-hash-sharding.md`](docs/zh/developer-guide/task-uid-hash-sharding.md)
- English version: [`docs/en/developer-guide/task-uid-hash-sharding.md`](docs/en/developer-guide/task-uid-hash-sharding.md)
...
- Search AI image recognition: [`docs/zh/developer-guide/search-ai-image-recognition.md`](docs/zh/developer-guide/search-ai-image-recognition.md)
- English version: [`docs/en/developer-guide/search-ai-image-recognition.md`](docs/en/developer-guide/search-ai-image-recognition.md)
...
- Wework cloud sync architecture design: [`docs/zh/developer-guide/wework-cloud-sync-design.md`](docs/zh/developer-guide/wework-cloud-sync-design.md)
- English version: [`docs/en/developer-guide/wework-cloud-sync-design.md`](docs/en/developer-guide/wework-cloud-sync-design.md)
- Wework cloud sync development plan: [`docs/zh/developer-guide/wework-cloud-sync-development.md`](docs/zh/developer-guide/wework-cloud-sync-development.md)
- English version: [`docs/en/developer-guide/wework-cloud-sync-development.md`](docs/en/developer-guide/wework-cloud-sync-development.md)
...
**Tech:** Python, Docker SDK, Kubernetes Client, FastAPI, APScheduler
...
- `executors/k8s/k8s_executor.py` - Kubernetes pod lifecycle
...
- Docker Mode: `NETWORK`, `EXECUTOR_WORKSPACE`, `PORT_RANGE_MIN/MAX` (10000-10100)
- K8s Mode: `K8S_NAMESPACE`, `EXECUTOR_DEFAULT_IMAGE`
