...
/**
 * Desktop-specific implementation of Knowledge Page
 *
 ...
 *
 * @see KnowledgePageMobile.tsx for mobile implementation
 */
export function KnowledgePageDesktop() {
  ...
  // Mobile sidebar state (not used on desktop but required for TaskSidebar)
