  ...
  const handleSubmitClick = () => {
    if (isContentEmpty()) {
      toast({
        ...
        description: t(
          'answers.content_required',
          'Please enter your answer or upload attachments'
        ),
        variant: 'destructive',
      })
      return
    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t('answers.confirm_submit_title', 'Confirm Submission')}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t(
                'answers.confirm_submit_description',
                'This will overwrite your previous submission. Are you sure you want to continue?'
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
