              ...
              paragraphAction
                ? {
                    a: ({ href, children, ...props }) => {
                      // Use SmartLink for URLs to render as image preview or link card
                    ...
                    img: ({ src, alt, ...props }) => {
                      // Use ImagePreview for images with Lightbox support
                      if (src) {
                        return <ImagePreview src={src} alt={alt} maxWidth={300} maxHeight={200} />;
                      }
