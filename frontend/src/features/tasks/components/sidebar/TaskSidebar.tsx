...
export default function TaskSidebar({
        ...
        {buttons.map(btn => (
          <div key={btn.path} className="relative group">
            <Button
              ...
              className={`w-full justify-start px-3 h-11 min-w-[44px] text-sm rounded-md transition-all duration-200 md:h-8 ${
                btn.isActive
                  ...
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className="flex h-11 min-w-[44px] items-center gap-1 px-2 text-xs bg-primary text-white rounded-md hover:bg-primary/90 transition-colors md:h-8"
                      >
        ...
        >
          {buttons.map(btn => (
            <DropdownMenuItem
              ...
              className={`h-11 min-w-[44px] gap-2 px-2 text-sm md:h-8 ${
                btn.isActive
                    ...
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <button
                          ...
                          className="flex h-11 min-w-[44px] flex-shrink-0 items-center justify-center md:h-8"
                      ...
                      <Tooltip delayDuration={300}>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            className="h-11 min-w-[44px] w-11 p-0 text-text-muted hover:text-text-primary hover:bg-hover rounded-lg md:h-10 md:w-10 md:min-w-10"
              ...
              {!isCollapsed && (
                <div className="mb-0.5">
                  <Button
                    ...
                    data-testid="new-agent-button"
                    className="w-full justify-start px-3 h-11 min-w-[44px] text-sm text-text-primary hover:bg-[rgb(238,238,238)] dark:hover:bg-white/10 rounded-md group transition-all duration-200 md:h-8"
                    size="sm"
                  >
                    <span className="flex min-w-0 flex-1 items-center justify-start gap-2.5 text-left">
  ...
  return (
    <>
      ...
      <div
        className="hidden md:flex md:flex-col w-full h-full bg-base rounded-3xl shadow-sidebar my-2"
