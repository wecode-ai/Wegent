...
export function MobileChatInputControls({
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center gap-1 flex-shrink-0 ${hideSelectors ? 'hidden' : ''}`} data-tour="input-controls">
        {/* Attachment */}
      ...
      <div className="flex items-center gap-2 min-w-0 overflow-hidden">
        {selectedTeam && (
          <div className={`min-w-0 overflow-hidden ${hideSelectors ? 'hidden' : ''}`}>
            <MobileModelSelector
