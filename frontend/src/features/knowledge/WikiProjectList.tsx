      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center py-16">
        ...
        >
          ...
          <h3 className="font-medium text-base mb-2 text-text-primary">
            {t('knowledge:wiki.add_repository')}
          </h3>
          <p className="text-sm text-text-muted text-center">{t('knowledge:wiki.add_repository_desc')}</p>
        </Card>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        >
          ...
          <h3 className="font-medium text-sm">{t('knowledge:wiki.add_repository')}</h3>
        </Card>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {onRegenerateClick && (
                      <button
                        ...
                        title={t('knowledge:wiki.regenerate')}
                    ...
                    <button
                      ...
                      title={t('knowledge:wiki.view_detail')}
                    >
                      <svg
                        className="w-4 h-4"
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {isTaskExecutor ? (
                        <button
                          ...
                          title={t('knowledge:wiki.view_task')}
                        >
                          <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse"></span>
                          {t('knowledge:wiki.indexing')}
                        </button>
                      ) : (
