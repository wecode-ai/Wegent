  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={open => !open && onClose()}>
      <AlertDialogContent className="max-w-sm">
        <AlertDialogHeader>
          <AlertDialogTitle>{t('knowledge:wiki.cancel_dialog_title')}</AlertDialogTitle>
          <AlertDialogDescription>{t('knowledge:wiki.cancel_dialog_description')}</AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
