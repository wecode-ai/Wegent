...
interface ClaudeModelFormProps {
  formData: Record<string, any>;
  onChange: (field: string, value: string) => void;
  errors?: Record<string, boolean>;
}

const ClaudeModelForm: React.FC<ClaudeModelFormProps> = ({ formData, onChange, errors = {} }) => {
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          placeholder={t('settings.model.base_url_placeholder')}
...
export default ClaudeModelForm;
