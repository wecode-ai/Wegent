...
describe('ExternalWikiConnectionCard deletion', () => {
  beforeEach(() => {
    ...
    mockListConnections.mockResolvedValue({
      ...
      available_connectors: legacyConnection.available_connectors,
    })
    mockGetConnection.mockResolvedValue(legacyConnection)
  })

  it('confirms and deletes the legacy connection', async () => {
    ...
    expect(screen.getByText(/如果连接仍被 Live Wiki 或同步 Wiki/)).toBeInTheDocument()
    ...
    await waitFor(() => expect(mockDeleteConnection).toHaveBeenCalledWith('legacy-default'))
