...
export const MODEL_MODALITY_ICON_COLORS: Record<ModelModality, string> = {
  text: 'text-text-muted',
  image: 'text-sky-600',
  video: 'text-emerald-600',
}

export const MODEL_MODALITY_BADGE_STYLES: Record<ModelModality, string> = {
      ...
      {modalities.map(modality => {
        ...
        return (
          <span
            ...
            className={cn(
              'group relative inline-flex h-5 w-5 shrink-0 cursor-help items-center justify-center',
              MODEL_MODALITY_ICON_COLORS[modality]
            )}
          >
