...
export class AdminUsersPage extends BasePage {
  ...
  async fillUserForm(userData: {
    ...
    // Select role
    if (userData.role) {
      const roleSelector = this.page.locator('[data-testid="role-select"], [role="combobox"]:has-text("Role")')
  ...
  getUserRow(username: string): Locator {
    return this.page.locator(`tr:has-text("${username}"), [data-testid="user-row"]:has-text("${username}")`)
  }
