...
export class SettingsBasePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.tabIntegrations = page.locator('[data-tab="integrations"], button:has-text("Integrations")')
   ...
   */
  async switchTab(tab: 'bots' | 'team' | 'models' | 'shells' | 'skills' | 'integrations'): Promise<void> {
    const tabLocator = {
      bots: this.tabBots,
      team: this.tabTeams,
